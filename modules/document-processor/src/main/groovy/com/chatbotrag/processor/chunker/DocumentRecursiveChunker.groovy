package com.chatbotrag.processor.chunker
...
@Singleton
@Slf4j
class DocumentRecursiveChunker implements DocumentChunker {
    ...
    Mono<List<TextSegment>> chunk(Document document) {
        Mono.fromCallable(() -> {
            try {
                ...
                log.debug("Recursive chunking completed for '{}': {} segments created, avg length {} chars",
                    fileName, 
                    segments.size(), 
